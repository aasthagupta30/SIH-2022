					...
					<div className='wrapper'>
						...
						<div id='nav_mid' className='nav-mid'>
							<Link to='/doctors' className={`prod ${pathname === '/doctors' ? 'active' : ''}`}>
								<div className='prod-title'> Find Experts  </div>{' '}
							...
							>
								...
								<div className='prod-sub'> Consult top experts </div>{' '}
							</Link>{' '}
							<div className='prod' id='medicines'>
								<div className='prod-title'> Schemes </div>{' '}
								<div className='prod-sub'> Offered By Government </div>{' '}
							</div>{' '}
							<div className='prod' id='lab_tests'>
								<div className='prod-title'> Crop Test </div>{' '}
								<div className='prod-sub'> Book a test </div>{' '}
							</div>{' '}
							<div className='prod' id='surgeries'>
								<div className='prod-title'> Agriculture News </div>{' '}
								<div className='prod-sub'> Daily updates </div>{' '}
							</div>{' '}
						</div>{' '}
						<div
							style={{
